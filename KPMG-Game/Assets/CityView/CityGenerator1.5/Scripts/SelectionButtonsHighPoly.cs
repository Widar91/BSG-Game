...
public class SelectionButtonsHighPoly : MonoBehaviour {
...
t.transform.gameObject.GetComponent<BuildBuildingHighPoly>().useBuilding = false;
...
foreach (Transform t in ts) {
if(t.transform.gameObject.layer == 8){
t.transform.gameObject.GetComponent<BuildBuildingHighPoly>().usedName = "Building";
					
t.transform.gameObject.GetComponent<BuildPark>().usePark = false;
t.transform.gameObject.GetComponent<BuildParking>().useParking = false;
t.transform.gameObject.GetComponent<BuildBuildingHighPoly>().useBuilding = true;
...
if(generator.GetComponent<CityGeneratorHighPoly>().end == true){		
...
if(t.transform.gameObject.name == "3DButton" || t.transform.gameObject.name == "3DButton(Clone)" || t.transform.gameObject.name == "3DButtonHighPoly(Clone)" || t.transform.gameObject.name == "3DButtonHighPoly"){	
Destroy(t.transform.gameObject);
}
				
if(t.transform.gameObject.name == "Building"){	
t.transform.gameObject.GetComponent<BuildBuildingHighPoly>().enabled = true;
t.transform.gameObject.GetComponent<BuildBuildingHighPoly>().generate = true;
t.transform.gameObject.GetComponent<BuildBuildingHighPoly>().activate = true;
}
