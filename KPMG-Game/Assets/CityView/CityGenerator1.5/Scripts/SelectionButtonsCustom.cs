...
public class SelectionButtonsCustom : MonoBehaviour {
...
t.transform.gameObject.GetComponent<BuildBuildingCustom>().useBuilding = false;
...
foreach (Transform t in ts) {
if(t.transform.gameObject.layer == 8){
t.transform.gameObject.GetComponent<BuildBuildingCustom>().usedName = "Building";
					
t.transform.gameObject.GetComponent<BuildPark>().usePark = false;
t.transform.gameObject.GetComponent<BuildParking>().useParking = false;
t.transform.gameObject.GetComponent<BuildBuildingCustom>().useBuilding = true;
...
if(generator.GetComponent<CityGeneratorCustom>().end == true){		
...
if(t.transform.gameObject.name == "3DButtonCustom" || t.transform.gameObject.name == "3DButtonCustom(Clone)" || t.transform.gameObject.name == "3DButton(Clone)" || t.transform.gameObject.name == "3DButton"){	
Destroy(t.transform.gameObject);
}
				
if(t.transform.gameObject.name == "Building"){	
t.transform.gameObject.GetComponent<BuildBuildingCustom>().enabled = true;
t.transform.gameObject.GetComponent<BuildBuildingCustom>().generate = true;
t.transform.gameObject.GetComponent<BuildBuildingCustom>().activate = true;
}
